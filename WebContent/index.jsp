		...
		<form action="${pageContext.request.contextPath}/user/login" method="post">
			<table border="0px" width="1321" height="585" >
				...
				<tr height="10">
					...
					<td width="5%">&nbsp;用户名：</td>
					<td width="10%"><input type="text" value="${user.userName }" name="userName" id="userName" size="17" height="10"/></td>
			  ...
			  <tr height="10">
                    <td width="35%" height="23"></td>
                    <td width="5%">&nbsp;密  码：</td>
					<td><input type="password" value="${user.password }" name="password" id="password"  size="17"  height="10"/></td>
				 ...
				 <tr height="10">
                    ...
                    <td width="5%">&nbsp;验证码：</td>
                    <td><input type="text" value="${imageCode }" name="imageCode" id="imageCode" size="5" />&nbsp;<img onclick="javascript:loadimage();"  title="换一张试试" name="randImage" id="randImage" src="pages/admin/image.jsp" width="60" height="20" border="1" align="middle"></td>
                    <td width="50%"></td>
			  </tr> 
                <tr>
